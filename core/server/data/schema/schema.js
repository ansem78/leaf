module.exports = {
  ...
  settings : {
    ...
    name : {type : 'string',maxlength : 191,nullable : false,unique : true,validation : {matches : /^[a-z_][a-z0-9_]*$/gi}},
  ...
  roles : {
    id : {type : 'string',maxlength : 24,nullable : false,primary : true},
    slug : {type : 'string',maxlength : 191,nullable : false,defaultTo : 'author',validations : {isIn : ['author','editor','admin','owner']}},
  ...
  users : {
    ...
    language : {type : 'string',maxlength : 7,nullable : false,defaultTo : 'en_US'},
